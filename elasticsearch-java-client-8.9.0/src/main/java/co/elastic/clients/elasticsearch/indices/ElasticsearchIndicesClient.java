...
@Weave
public abstract class ElasticsearchIndicesClient {
	...
	public DeleteDataLifecycleResponse deleteDataLifecycle(DeleteDataLifecycleRequest request) {
		...
		Endpoint<DeleteDataLifecycleRequest, DeleteDataLifecycleResponse, ErrorResponse> endPoint = DeleteDataLifecycleRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
	...
	@Trace(leaf = true)
	public DownsampleResponse downsample(DownsampleRequest request) {
		TracedMethod traced = NewRelic.getAgent().getTracedMethod();
		Map<String, String> collectionAttr = new HashMap<String, String>();
		String indices = Utils.getObjectString(request.index());
		if(indices != null) {
		...
		String target = request.targetIndex();
		if(target != null) {
			collectionAttr.put("targetIndex", target);
		}
		Endpoint<DownsampleRequest, DownsampleResponse, ErrorResponse> endPoint = DownsampleRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
	...
	public ExplainDataLifecycleResponse explainDataLifecycle(ExplainDataLifecycleRequest request) {
		...
		Endpoint<ExplainDataLifecycleRequest, ExplainDataLifecycleResponse, ErrorResponse> endPoint = ExplainDataLifecycleRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
	...
	public FieldUsageStatsResponse fieldUsageStats(FieldUsageStatsRequest request) {
		...
		Endpoint<FieldUsageStatsRequest, FieldUsageStatsResponse, ErrorResponse> endPoint = FieldUsageStatsRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
	...
	public GetDataLifecycleResponse getDataLifecycle(GetDataLifecycleRequest request) {
		...
		Endpoint<GetDataLifecycleRequest, GetDataLifecycleResponse, ErrorResponse> endPoint = GetDataLifecycleRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
	...
	public ModifyDataStreamResponse modifyDataStream(ModifyDataStreamRequest request) {
		...
		Map<String, String> collectionAttr = new HashMap<String, String>();
		collectionAttr.put("", "");
		Endpoint<ModifyDataStreamRequest, ModifyDataStreamResponse, ErrorResponse> endPoint = ModifyDataStreamRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
	...
	public PutDataLifecycleResponse putDataLifecycle(PutDataLifecycleRequest request) {
		...
		Endpoint<PutDataLifecycleRequest, PutDataLifecycleResponse, ErrorResponse> endPoint = PutDataLifecycleRequest._ENDPOINT;
		DatastoreParameters params = Utils.getParams(request, collectionAttr, endPoint.queryParameters(request), null);
